...
export const TextB2 = styled(TextB1)`
  font-size: 16px;
  font-weight: 400;
  line-height: 1.3;
`;

export const TextB3 = styled(TextB1)`
  font-size: 14px;
  font-weight: 400;
  line-height: 1.2;
`;

export const TextB4 = styled(TextB1)`
  font-family: 'Inter';
  font-size: 12px;
  font-weight: 400;
  line-height: 1;
...
export const TextB5 = styled(TextB4)`
  line-height: 1.2;
`;

export const TextB6 = styled(TextB4)`
  font-size: 10px;
`;

export const TextB7 = styled(TextB1)`
  font-size: 10px;
  line-height: 1.2;
`;
