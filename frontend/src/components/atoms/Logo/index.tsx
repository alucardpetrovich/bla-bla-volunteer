...
const Logo = ({ height, width, ...props }: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      style={{ fill: '#B3B3B3' }}
      d="M434.439,110.654C401.179,45.876,334.359,0.003,255.98,0v101.329
      c55.478,0.004,100.593,43.67,100.595,99.15c0,54.805-45.491,102.048-100.595,102.052V512
      c70.646-73.617,151.953-154.542,187.529-251.428C461.298,212.121,457.979,156.5,434.439,110.654z"
    />
    <path
      style={{ fill: '#979797' }}
      d="M68.492,260.572C104.067,357.458,185.374,438.383,256.02,512V302.531
    ...
    <path
      style={{ fill: '#C7C7C7' }}
      d="M255.929,21.707c-73.745,0-141.451,47.552-166.61,116.806
