...
export { default as teaser_1 } from './teaser_img_1.png';
export { default as teaser_2 } from './teaser_img_2.png';
export { default as teaser_3 } from './teaser_img_3.png';
export { default as teaser_4 } from './teaser_img_4.png';
